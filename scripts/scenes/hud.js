class HudScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('left-button', 'assets/gamepad/left-arrow-120px.png');
    this.load.image('right-button', 'assets/gamepad/right-arrow-120px.png');
  ...
  create() {
    this.leftButton = this.add.image(280, 740, 'left-button');
    this.rightButton = this.add.image(450, 740, 'right-button');
    this.upButton = this.add.image(900, 740, 'up-button');
